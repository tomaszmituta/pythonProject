    ...
    try:
        for x in range(1, 200):
            username = webdriver.find_element_by_xpath(
                '/html/body/div[2]/div[2]/div/div/article/header/div[2]/div/div[/h2/a').text

            if username not in prev_user_list:
                # If we already follow, do not unfollow
                if webdriver.find_element_by_xpath(
                        '/html/body/div[2]/div[2]/div/article/header/div[2]/div/div[2]/button').text == 'Obserwuj':

                    webdriver.find_element_by_xpath(
                        '/html/body/div[2]/div[2]/div/article/header/div[2]/div/div[2]/button').click()
